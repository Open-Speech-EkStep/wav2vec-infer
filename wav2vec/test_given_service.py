...
from wav2vec.inference_service import InferenceService
...
def listen_for_speech(threshold=THRESHOLD, num_phrases=-1):
    ...
    n = num_phrases
    response = []
    # hello --- what are you upto? ---  I think we have a problem
...
def stt_google_wav(audio_fname):
    return service.get_inference(audio_fname, 'hi')['transcription']


if __name__ == '__main__':
    listen_for_speech(num_phrases=3)  # listen to mic.
    service = InferenceService("./../model_dict.json")
